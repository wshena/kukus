...
const Tags = ({id, initialData, tags}:{id:number, initialData:any, tags:string}) => {
  ...
  return (
    <>
      <Stack alignItems={'start'} gap={'20px'}>
        <Heading as={'h1'} fontSize={{base:'2rem', md:'2rem'}} textTransform={'capitalize'} fontWeight={'bold'}>{tags} games</Heading>
        <Text width={{base:'100%', md:'70%'}}>Kukus Games Store offers some of the best {tags} games. Download today and start playing fun and exciting PC {tags} games.</Text>
      </Stack>
